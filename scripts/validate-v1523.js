...
if(!html.includes('V15.23.2')||!html.includes('v=15.23.2')||!cfg.includes("version: '15.23.2'")||!sw.includes('v15.23.2-pdf-entrega')) fail('Versão/cache inconsistente');
console.log(JSON.stringify({ok:true,secoes:16,itens:171,modeloRemoto:'checklis_sos_v15',versao:'15.23.2'},null,2));
